...
class RegistriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registry" do
    assert_difference('Registry.count') do
      post registries_url, params: { registry: { address: @registry.address, code: @registry.code, county: @registry.county, email: @registry.email, holder: @registry.holder, last_update: @registry.last_update, organ: @registry.organ } }
    end
  ...
  test "should update registry" do
    patch registry_url(@registry), params: { registry: { address: @registry.address, code: @registry.code, county: @registry.county, email: @registry.email, holder: @registry.holder, last_update: @registry.last_update, organ: @registry.organ } }
